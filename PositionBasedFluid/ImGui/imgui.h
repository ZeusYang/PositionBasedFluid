...
namespace ImGui
{
	...
	/* 
	** push window to the stack and start appending to it. see .cpp for details. 
	...
	*/
	...
	/* 
	** OBSOLETE. this is the older/longer API. the extra parameters aren't very 
	** relevant. call SetNextWindowSize() instead if you want to set a window size. 
	** For regular windows, 'size_on_first_use' only applies to the first time 
	** EVER the window is created and probably not what you want! might obsolete 
	** this API eventually.
	*/
